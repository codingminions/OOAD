...
public class VehicleInventory implements AddOnInterface
{
    ...
    protected ArrayList<VehicleInventory> Ambulances = new ArrayList<>();
    protected ArrayList<VehicleInventory> Bus = new ArrayList<>();
    protected ArrayList<VehicleInventory> SkateBoards = new ArrayList<>();
    ...
    protected void addCars(String modelType, VehicleInventory vehicle)
    {
        ...
        else if(modelType == "Ambulance")
        {
            this.Ambulances.add(vehicle);
            this.modelType = "Ambulance";
        }
        else if(modelType == "Bus")
        {
            this.Bus.add(vehicle);
            this.modelType = "Bus";
        }
        else if(modelType == "SkateBoard")
        {
            this.SkateBoards.add(vehicle);
            this.modelType = "SkateBoard";
        }
    }
    ...
    protected void removeCars(String modelType, VehicleInventory vehicle)
    {
        ...
        if(modelType == "Ambulance")
        {
            Ambulances.remove(vehicle);
        }
        if(modelType == "Bus")
        {
            Bus.remove(vehicle);
        }
        if(modelType == "SkateBoard")
        {
            SkateBoards.remove(vehicle);
        }
    }
    ...
    protected ArrayList<VehicleInventory> getCleanVehicles(){
        ...
        for(VehicleInventory skate: SkateBoards){
            if(skate.cleanliness == "clean"){
                cleanCars.add(skate);
            }
        }

        for(VehicleInventory ambulance: Ambulances){
            if(ambulance.cleanliness == "clean"){
                cleanCars.add(ambulance);
            }
        }

        for(VehicleInventory bus: Bus){
            if(bus.cleanliness == "clean"){
                cleanCars.add(bus);
            }
        }
    ...
    protected ArrayList<VehicleInventory> getDirtyVehicles(){
        ...
        for(VehicleInventory skate: SkateBoards){
            if(skate.cleanliness == "dirty"){
                dirtyCars.add(skate);
            }
        }

        for(VehicleInventory ambulance: Ambulances){
            if(ambulance.cleanliness == "dirty"){
                dirtyCars.add(ambulance);
            }
        }

        for(VehicleInventory bus: Bus){
            if(bus.cleanliness == "dirty"){
                dirtyCars.add(bus);
            }
        }
    ...
    protected ArrayList<VehicleInventory> getBrokenVehicles()
    {
        ...
        for(VehicleInventory skate: SkateBoards){
            if(skate.condition == "Broken"){
                Brokencars.add(skate);
            }
        }

        for(VehicleInventory ambulance: Ambulances){
            if(ambulance.condition == "Broken"){
                Brokencars.add(ambulance);
            }
        }

        for(VehicleInventory bus: Bus){
            if(bus.condition == "Broken"){
                Brokencars.add(bus);
            }
        }
    ...
    protected ArrayList<VehicleInventory> getUsedVehicles()
    {
        ...
        for(VehicleInventory skate: SkateBoards){
            if(skate.condition == "Used"){
                Usedvehicles.add(skate);
            } 
        }

        for(VehicleInventory ambulance: Ambulances){
            if(ambulance.condition == "Used"){
                Usedvehicles.add(ambulance);
            } 
        }

        for(VehicleInventory bus: Bus){
            if(bus.condition == "Used"){
                Usedvehicles.add(bus);
            } 
        }
    ...
    protected ArrayList<VehicleInventory> getAllVehicles()
    {
        ...
        allVehicles.addAll(SkateBoards);
        allVehicles.addAll(Ambulances);
        allVehicles.addAll(Bus);
        return allVehicles;
    }
}